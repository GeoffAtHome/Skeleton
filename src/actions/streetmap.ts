...
export interface PostcodeData {
    ...
    numberOfProperties?: number,
    streetorder?: string,
    district_sort_box?: string,
    local_sort_box?: string,
    dsb?: string,
    lsb?: string
}

export interface StreetMapStreetId extends Action<'STREET_ID'> { _index: string };
export interface StreetMapDataLoaded extends Action<'DATA_LOADED'> { _data: IStreetMapState };
export interface StreetMapStreetsLoaded extends Action<'STREETS_LOADED'> { _streets: Array<string> };
export interface StreetMapStreetInfoLoaded extends Action<'STREETINFO_LOADED'> { _streetInfo: StreetInfoData };
export interface StreetMapStreetMoveMap extends Action<'ST_MOVE_MAP'> { _latlng: google.maps.LatLngLiteral };
export interface StreetMapStreetEditPath extends Action<'EDIT_PATH'> { };
export interface StreetMapStreetDisplayDetailsDialog extends Action<'DISPLAY_DETAILS_DIALOG'> { };
export interface StreetMapStreetUpdateStreetItem extends Action<'UPDATE_STREET'> { _key: string, _item: StreetInfoItem };
export interface StreetMapStreetCancelDialogs extends Action<'CANCEL_DIALOGS'> { };
export interface StreetMapStreetEditLabel extends Action<'EDIT_LABEL'> { _index: number };
export interface StreetMapChanges extends Action<'STREET_MAP_CHANGES'> { _docs: StreetInfoItem };
export interface StreetMapDeletes extends Action<'STREET_MAP_DELETES'> { _docs: StreetInfoItem };
  

export type StreetMapAction = StreetMapDeletes | StreetMapChanges | StreetMapStreetId | StreetMapStreetInfoLoaded | StreetMapDataLoaded | StreetMapStreetEditPath | StreetMapStreetUpdateStreetItem | StreetMapStreetCancelDialogs | StreetMapStreetMoveMap | StreetMapStreetsLoaded | StreetMapStreetDisplayDetailsDialog | StreetMapStreetEditLabel
...
export const streetMapUpdateStreetItem: ActionCreator<StreetMapStreetUpdateStreetItem> = (_key, _item) => {
    return ({
        type: UPDATE_STREET,
        _key,
        _item
